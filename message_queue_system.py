...
class MessageQueueSystem:
    ...
    def __init__(self,persistent):
        ...
        if self.persistent:
            ...
            self.message_table = MessageDBMS(self.conn, self.cur,self.lock)
            self.producer_table = ProducerDBMS(self.conn, self.cur,self.lock)
            self.topic_table = TopicDBMS(self.conn, self.cur,self.lock)
            self.reset_dbms()
